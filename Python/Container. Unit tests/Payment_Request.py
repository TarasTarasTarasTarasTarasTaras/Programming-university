...
class PAYMENT_REQUEST:
    ...
    def __eq__(self, other):
        return self.get_id() == other.get_id() \
            ...
            and self.get_currency() == other.get_currency() \
            and self.get_payer_email() == other.get_payer_email() \
            and self.get_payment_due_to_date() == other.get_payment_due_to_date() \
            and self.get_payment_request_date() == other.get_payment_request_date() \
            and self.get_transaction_id() == other.get_transaction_id() 
